...
export const INTEGRATION_PROVIDERS: IntegrationProvider[] = [
  ...
  // Africa
  { id: 'interswitch', name: 'Interswitch', category: 'PAYMENT', description: 'Switch & payments (Nigeria)', icon: 'credit-card' },
  { id: 'yoco', name: 'Yoco', category: 'PAYMENT', description: 'Card & POS (South Africa)', icon: 'credit-card' },
  { id: 'payfast', name: 'PayFast', category: 'PAYMENT', description: 'Online payments (South Africa)', icon: 'wallet' },
  { id: 'dpo', name: 'DPO Group', category: 'PAYMENT', description: 'Pan-African card acquiring', icon: 'credit-card' },
  { id: 'pesapal', name: 'PesaPal', category: 'PAYMENT', description: 'Payments (Kenya)', icon: 'wallet' },
  { id: 'payoneer', name: 'Payoneer', category: 'PAYMENT', description: 'Cross-border payouts', icon: 'banknote' },
  // South & Southeast Asia
  { id: 'cashfree', name: 'Cashfree', category: 'PAYMENT', description: 'Payments (India)', icon: 'wallet' },
  { id: 'paytm', name: 'Paytm', category: 'PAYMENT', description: 'Wallets & UPI (India)', icon: 'smartphone' },
  { id: 'phonepe', name: 'PhonePe', category: 'PAYMENT', description: 'UPI payments (India)', icon: 'smartphone' },
  { id: 'safepay', name: 'SafePay', category: 'PAYMENT', description: 'Payments (Pakistan)', icon: 'wallet' },
  { id: 'sslcommerz', name: 'SSLCommerz', category: 'PAYMENT', description: 'Payments (Bangladesh)', icon: 'wallet' },
  { id: 'xendit', name: 'Xendit', category: 'PAYMENT', description: 'Payments (Indonesia & PH)', icon: 'wallet' },
  { id: '2c2p', name: '2C2P', category: 'PAYMENT', description: 'Payments gateway (Thailand/SEA)', icon: 'credit-card' },
  { id: 'ipay88', name: 'iPay88', category: 'PAYMENT', description: 'Payments (Malaysia)', icon: 'wallet' },
  { id: 'vnpay', name: 'VNPay', category: 'PAYMENT', description: 'Payments (Vietnam)', icon: 'wallet' },
  { id: 'unionpay', name: 'UnionPay', category: 'PAYMENT', description: 'Card network (China)', icon: 'credit-card' },
  // Middle East & Turkey
  { id: 'telr', name: 'Telr', category: 'PAYMENT', description: 'Payments (UAE/GCC)', icon: 'wallet' },
  { id: 'paytabs', name: 'PayTabs', category: 'PAYMENT', description: 'Payments (Saudi/UAE)', icon: 'wallet' },
  { id: 'moyasar', name: 'Moyasar', category: 'PAYMENT', description: 'Payments (Saudi Arabia)', icon: 'wallet' },
  { id: 'hyperpay', name: 'HyperPay', category: 'PAYMENT', description: 'Payments (Saudi Arabia)', icon: 'credit-card' },
  { id: 'amazon-payment-services', name: 'Amazon Payment Services', category: 'PAYMENT', description: 'Payments (MENA, ex-PayMee)', icon: 'credit-card' },
  { id: 'noon-pay', name: 'noon Pay', category: 'PAYMENT', description: 'Wallet & cards (MENA)', icon: 'smartphone' },
  { id: 'tap', name: 'Tap Payments', category: 'PAYMENT', description: 'Payments (Kuwait/GCC)', icon: 'wallet' },
  { id: 'iyzico', name: 'iyzico', category: 'PAYMENT', description: 'Payments (Turkey)', icon: 'wallet' },
  // East Asia
  { id: 'tosspayments', name: 'Toss Payments', category: 'PAYMENT', description: 'Payments (South Korea)', icon: 'wallet' },
  { id: 'kg-inicis', name: 'KG Inicis', category: 'PAYMENT', description: 'PG (South Korea)', icon: 'credit-card' },
  { id: 'multi-payment', name: 'Multi Payment', category: 'PAYMENT', description: 'Payments (Japan)', icon: 'wallet' },
  { id: 'gmo-payment-gateway', name: 'GMO Payment Gateway', category: 'PAYMENT', description: 'Payments (Japan)', icon: 'credit-card' },
  // Europe & Oceania
  { id: 'mollie', name: 'Mollie', category: 'PAYMENT', description: 'Payments (Europe)', icon: 'wallet' },
  { id: 'worldline', name: 'Worldline', category: 'PAYMENT', description: 'Acquiring & payments (EU)', icon: 'credit-card' },
  { id: 'nuvei', name: 'Nuvei', category: 'PAYMENT', description: 'Global payment orchestration', icon: 'globe' },
  { id: 'sumup', name: 'SumUp', category: 'PAYMENT', description: 'Card readers & payments', icon: 'credit-card' },
  { id: 'bambora', name: 'Bambora', category: 'PAYMENT', description: 'Card processing (CA/EU)', icon: 'credit-card' },
  { id: 'windcave', name: 'WINDCAVE', category: 'PAYMENT', description: 'Payments (AU/NZ)', icon: 'wallet' },
  { id: 'pin-payments', name: 'PIN Payments', category: 'PAYMENT', description: 'Payments (Australia)', icon: 'credit-card' },
  { id: 'pagseguro', name: 'PagSeguro', category: 'PAYMENT', description: 'Payments (Brazil)', icon: 'credit-card' },
